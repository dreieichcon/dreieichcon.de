...
<?php
    ...
    if(!isset($_POST['event_id']) || !isset($_POST['image_language'])){
        include("400.php");
	...
	// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $new_file)) {
            ...
            if($language == "de"){
                $data['event_image_href_de']         = $new_file_name.".".$imageFileType;
                $data['event_image_alt_de']          = $_POST['event_image_alt'];
                $data['event_image_copy_de']          = $_POST['event_image_copy'];
                
            }else{
                $data['event_image_href_en']         = $new_file_name.".".$imageFileType;
                $data['event_image_alt_en']          = $_POST['event_image_alt'];
                $data['event_image_copy_en']          = $_POST['event_image_copy'];
            }
