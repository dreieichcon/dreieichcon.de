...
if(!isset($_GET['page_bio_gallery_id']) || !isset($_GET['lang'])){
    include("400.php");
...
$wh['col'] = "page_bio_gallery_id";
$wh['typ'] = "=";
$wh['val'] = $_GET['page_bio_gallery_id'];
array_push($where, $wh);

$query		= "Blog-Bild löschen";
$db_result 	= db_update("page_bio_gallery", $data, $where);




$page_bio_gallery_id = htmlspecialchars($_GET['page_bio_gallery_id']);
