...
if(!isset($_POST['page_bio_id']) || !isset($_POST['image_language'])){
    include("400.php");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $new_file)) {
        ...
        if($language == "de"){
            $data['page_bio_image_de']              = $new_file_name.".".$imageFileType;
            $data['page_bio_image_alt_de']          = $_POST['page_bio_image_alt'];
            $data['page_bio_image_copy_de']          = $_POST['page_bio_image_copy'];
            
        }else{
            $data['page_bio_image_en']              = $new_file_name.".".$imageFileType;
            $data['page_bio_image_alt_en']          = $_POST['page_bio_image_alt'];
            $data['page_bio_image_copy_en']          = $_POST['page_bio_image_copy'];
        }
...
$page_bio_id = htmlspecialchars($_POST['page_bio_id']);
