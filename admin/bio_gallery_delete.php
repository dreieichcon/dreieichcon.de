...
<?php
$key = $data['page_bio_gallery_text_de'];

$id  = $data['page_bio_gallery_id'];
$bioid  = $data['page_bio_id'];
        ...
        <div class="col-12">
            <div class="card bg-warning">
                ...
                <div class="card-footer">
					...
					<a href="index.php?page=bio_gallery_delete_do&bio_id=<?php echo $bioid; ?>&bio_gallery_id=<?php echo $id; ?>" title="Blog-Eintrag löschen" class="btn btn-danger">
