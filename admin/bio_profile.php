        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Profilbild</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="row">
	<div class="col-12">
		<div class="card">
				...
				<div class="row">
					<div class="col-4">
						<?php
							...
							if($data['page_bio_image_de']==""){
								$icon = $no_icon;
							}else{
                                
								$icon = $target_dir . $data['page_bio_image_de'];
                                if(!is_file($icon)){
                                    $icon = $no_icon;
                                }
							}
					...
					<div class="col-8" >
						...
						<form action="index.php?page=bio_profile_image_upload" method="POST" enctype="multipart/form-data" id="img_upload_form">
            ...
            <a href="index.php?page=bio_profile_image_delete&lang=de&page_bio_id=<?php echo $data['page_bio_id']; ?>" title="Bild löschen" class="btn btn-danger">
                    Bild löschen
...
<div class="row">
	<div class="col-12">
		<div class="card">
				...
				<div class="row">
					<div class="col-4">
						<?php
                            ...
                            $no_icon = $target_dir."noimg.png";
							if($data['page_bio_image_en']==""){
								$icon = $no_icon;
							}else{
                                
								$icon = $target_dir . $data['page_bio_image_en'];
                                if(!is_file($icon)){
                                    $icon = $no_icon;
                                }
							}
            ...
            <div class="card-footer">
            <a href="index.php?page=bio_profile_image_delete&lang=en&page_bio_id=<?php echo $data['page_bio_id']; ?>" title="Bild löschen" class="btn btn-danger">
                    Bild löschen
                    <span class="fas fa-trash"> </span>
                    </a>
            </div>
