...
<form action="index.php?page=gallery_add_script" method="POST">
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <input required type="number" name="page_gallery_order"  class="form-control" placeholder="">
                              </div>
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="page_gallery_href"  class="form-control" placeholder="">
                              </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <textarea required name="page_gallery_text_de" id="page_gallery_text_de" class="form-control" placeholder=""></textarea>
                              </div>
                            </div>
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <textarea required name="page_gallery_text_en" id="page_gallery_text_en" class="form-control" placeholder=""></textarea>
                              </div>
                            </div>
                        </div>
