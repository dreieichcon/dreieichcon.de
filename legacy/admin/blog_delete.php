...
?>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo($global_application_name_header);?> Blog-Eintrag löschen</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<?php
$key = $data['page_blog_headline_de'];

$id  = $data['page_blog_id'];
        ...
        <div class="col-12">
            <div class="card bg-warning">
                ...
                <div class="card-footer">
					...
					<a href="index.php?page=blog_delete_do&blog_id=<?php echo $id; ?>" title="Blog-Eintrag löschen" class="btn btn-danger">
                    ja, Blog-Eintrag löschen
